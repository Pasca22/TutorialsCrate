...
static constexpr auto qt_meta_stringdata_CLASSAdminGUIENDCLASS = QtMocHelpers::stringData(
    "AdminGUI"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSAdminGUIENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSAdminGUIENDCLASS_t qt_meta_stringdata_CLASSAdminGUIENDCLASS = {
    {
        QT_MOC_LITERAL(0, 8)   // "AdminGUI"
    },
    "AdminGUI"
};
